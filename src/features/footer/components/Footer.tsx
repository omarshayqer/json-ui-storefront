        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link href="/shop" className="text-gray-600 hover:text-brand">All Products</Link></li>
              <li><Link href="/shop?category=clothing" className="text-gray-600 hover:text-brand">Clothing</Link></li>
              <li><Link href="/shop?category=electronics" className="text-gray-600 hover:text-brand">Electronics</Link></li>
              <li><Link href="/shop?category=home" className="text-gray-600 hover:text-brand">Home</Link></li>
              <li><Link href="/shop?category=beauty" className="text-gray-600 hover:text-brand">Beauty</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-600 hover:text-brand">About Us</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-brand">Careers</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-brand">Contact Us</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-brand">Blog</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-600 hover:text-brand">Help Center</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-brand">Shipping</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-brand">Returns</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-brand">Privacy Policy</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-brand">Terms & Conditions</Link></li>
            </ul>
          </div>
        </div>
